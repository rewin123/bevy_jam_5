...
use crate::game::{character::GoToAction, pc_work::PcWorkAction, selectable::OnSelect, sequence::{NewActionSequence, NewMode, Sequence}, spawn::player::Player};
...
fn on_selected(
    ...
    if let Ok(mut pc_transform) = q_pcs.get_mut(target) {
